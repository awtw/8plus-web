...
- **圓角**：主容器/卡片/圖框 **20px**（signature）；按鈕/badge 藥丸 999px；小元件 10px。
...
- 這套藍橘＋四場景是否鎖定？（style-guide.html 看實際效果）
- 圓角要 **20px** 還是回到舊的 22px？
- 主場景要不要在部分行銷頁允許「深色島」開場（`.bg-dark`）作為變化，還是全程藍底？

---

*確認後鎖定，進入 Phase D（Logo / 主視覺 / 首頁 signature 動畫）。*
